      ...
      <Container>
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-8 sm:mb-10 md:mb-12">
          ...
          <div className="md:max-w-md">
            <p className="mt-4 sm:mt-6 md:mt-10 text-xs sm:text-sm md:text-sm leading-relaxed">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="rounded-2xl overflow-hidden bg-white shadow-lg hover:shadow-xl transition-all duration-300 flex flex-col">
            ...
            <div className="p-4 sm:p-6 flex flex-col flex-1">
              <h3 className="text-base sm:text-lg md:text-xl font-normal text-gray-900 mb-2 sm:mb-3 tracking-tight">Mental Health Services</h3>
              ...
              <button className="text-[#FF5810] font-semibold text-xs sm:text-sm flex items-center gap-2 hover:gap-3 transition-all mt-auto">
          ...
          <div className="rounded-2xl overflow-hidden bg-[#FF5810] shadow-lg hover:shadow-xl transition-all duration-300 relative flex flex-col">
            ...
            <div className="h-40 sm:h-48 relative">
              {/* Badge at Top */}
              <div className="absolute top-3 sm:top-4 left-3 sm:left-4 bg-white bg-opacity-90 rounded-lg px-2 sm:px-3 py-1.5 sm:py-2 flex items-center gap-1.5 sm:gap-2 z-10">
                <svg
                ...
                <span className="text-[10px] sm:text-xs font-medium text-gray-900">Cardiology</span>
                <span className="text-[10px] sm:text-xs text-gray-600">•</span>
                <span className="text-[10px] sm:text-xs font-medium text-gray-900">Dr. Waseem Khan</span>
              </div>
            </div>

            {/* Bottom Section - Text Content */}
            <div className="p-4 sm:p-6 flex flex-col flex-1">
              <h3 className="text-lg sm:text-xl md:text-2xl font-normal text-white mb-3 sm:mb-4 tracking-tight">Meet Our Expert Doctors</h3>
              <p className="text-white text-opacity-90 text-xs sm:text-sm md:text-base mb-4 sm:mb-6 leading-relaxed">
              ...
              <Button className="w-full rounded-4xl bg-black text-white hover:bg-gray-800 font-semibold py-4 sm:py-6 text-sm sm:text-base mt-auto">
                Book an Appointment
              </Button>
            </div>
          </div>
          ...
          <div className="rounded-2xl overflow-hidden bg-white shadow-lg hover:shadow-xl transition-all duration-300 flex flex-col sm:col-span-2 md:col-span-1">
            <div className="h-40 sm:h-48 relative overflow-hidden">
              <img
            ...
            <div className="p-4 sm:p-6 flex flex-col flex-1">
              <h3 className="text-base sm:text-lg md:text-xl font-normal text-gray-900 mb-2 sm:mb-3 tracking-tight">Individual Counseling</h3>
              <p className="text-gray-600 text-xs sm:text-sm md:text-base mb-3 sm:mb-4 leading-relaxed flex-1">
