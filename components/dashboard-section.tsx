    ...
    <section id="dashboard-section" className={`${SECTION_SPACING} bg-white`}>
      <Container>
        ...
        <div className="grid md:grid-cols-4 gap-6 auto-rows-max">
          {/* Welcome Card */}
          <div
            className={`md:col-span-2 rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 text-white p-8 h-64 flex flex-col justify-between transition-all duration-1000 ${isVisible ? "opacity-100" : "opacity-0"}`}
          >
            <div>
              <h3 className="text-xl md:text-2xl font-normal text-white mb-2 tracking-tight">Welcome Back! AURATALK</h3>
              <p className="text-blue-100">Check Your Health Regularly</p>
            </div>
            <button className="w-fit px-4 py-2 bg-white text-blue-600 font-semibold rounded-full text-sm hover:bg-blue-50 transition-colors">
              Check now
            </button>
          </div>
          ...
          <div
            className={`rounded-2xl bg-gradient-to-br from-pink-300 to-pink-400 text-white p-8 h-64 flex flex-col justify-between transition-all duration-1000 delay-100 ${isVisible ? "opacity-100" : "opacity-0"}`}
          >
            <h3 className="text-xl md:text-2xl font-normal text-white tracking-tight mb-4">Diabetes</h3>
            <div className="flex items-end justify-between">
              <div>
                <p className="text-sm text-pink-100">Score</p>
          ...
          {/* Doctor Profile Card */}
          <div
            className={`md:col-span-1 md:row-span-2 rounded-2xl bg-gradient-to-br from-purple-500 to-purple-600 text-white p-8 flex flex-col justify-between transition-all duration-1000 delay-200 ${isVisible ? "opacity-100" : "opacity-0"}`}
          >
            <div className="flex-1 flex flex-col justify-between">
              <div>
                <h3 className="text-xl md:text-2xl font-normal text-white mb-1 tracking-tight">Dr. Sarah Johnson</h3>
                <p className="text-purple-100 mb-2 font-medium">Cardiologist & Heart Specialist</p>
                <p className="text-sm text-purple-200 mb-4">15+ years of experience</p>
                ...
                <p className="text-sm text-purple-100">4.8 (200+ reviews)</p>
              </div>
            </div>
            <button className="w-fit px-6 py-2 bg-white text-purple-600 font-semibold rounded-full text-sm hover:bg-purple-50 transition-colors">
              Book Appointment
            </button>
          </div>
          ...
          <div
            className={`rounded-2xl bg-gradient-to-br from-orange-300 to-orange-400 text-white p-8 h-64  flex flex-col justify-between transition-all duration-1000 delay-300 ${isVisible ? "opacity-100" : "opacity-0"}`}
          >
            ...
            <div className="flex items-center justify-between">
              <p className="text-sm text-orange-100">Regular checkups prevent future health issues</p>
          ...
          <div
            className={`rounded-2xl bg-blue-300 text-white p-8 h-64  flex flex-col justify-between transition-all duration-1000 delay-500 ${isVisible ? "opacity-100" : "opacity-0"}`}
          >
            <h3 className="text-xl md:text-2xl font-normal text-white tracking-tight mb-4">Blood Pressure</h3>
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-sm text-blue-100">Current</span>
                <span className="text-2xl font-bold">120/80</span>
              </div>
              <p className="text-xs text-blue-100">Status: Normal</p>
            </div>
          </div>
        </div>
      </Container>
